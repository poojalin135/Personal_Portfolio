...
const Project = () => {
  ...
  return (
    <>
      <div ref={workRef} className="min-h-screen bg-white text-black py-24 lg:py-40 overflow-hidden" id='projects'>
        
        {/* Title Wrapper */}
        <div className='main-container pb-8 lg:pb-12 flex max-md:flex-col gap-6 justify-between items-start md:items-end'>
          <div className='max-w-xl'>
            <h3 className='mb-3 font-bold'>SELECTED PROJECTS</h3>
            <p className='text-lg lg:text-xl'>A showcase of my selected projects to inspire, engage, and deliver real results.</p>
          </div>
